...
;// CONCATENATED MODULE: ./src/Context/DragDropContext.js

const DragDropContext = /*#__PURE__*/(0,react.createContext)(null);
;// CONCATENATED MODULE: ./src/Context/SpritePosition.js

const SpritePositionContext = /*#__PURE__*/(0,react.createContext)(null);
;// CONCATENATED MODULE: ./src/components/Main/Events.js
...
const Events = () => {
  const {
    blocksState,
    setBlocksState
  } = (0,react.useContext)(DragDropContext);
  const {
    spritePosition,
    setSpritePosition
  } = (0,react.useContext)(SpritePositionContext);
  const handleStartAnimation = () => {};
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "font-bold text-center w-[90%]"
...
/* harmony default export */ const Main_Events = (Events);
;// CONCATENATED MODULE: ./src/Utilities/DragEvents.js
...
;// CONCATENATED MODULE: ./src/Utilities/MoveAnimations.js

const generateId = () => esm_browser_v4();
const getStyle = (blocksState, spritePosition, setSpritePosition) => {
  const newPosition = {
    ...spritePosition[spritePosition.length - 1]
  };
  newPosition.transform = '';
  blocksState.forEach(item => {
    switch (item.id) {
      case "SAY_TEXT_WITH_SECS":
        setSpritePosition(prevSpritePosition => [...prevSpritePosition, {
      ...
      case "MOVE_STEPS":
        if (newPosition.transform && newPosition.transform.indexOf("translateX(") !== -1) {
          ...
          } else newPosition.transform += "translateX(".concat(item.steps, "px)");
        } else newPosition.transform += "translateX(".concat(item.steps, "px)");
        break;
      case "TURN_LEFT":
        if (newPosition.transform && newPosition.transform.indexOf("rotate(") !== -1) {
          ...
          } else newPosition.transform += "rotate(".concat(-item.turnLeft, "deg)");
        } else newPosition.transform += "rotate(".concat(-item.turnLeft, "deg)");
        break;
      case "TURN_RIGHT":
        ...
        if (rotateRight !== -1) {
          ...
          } else newPosition.transform += "rotate(".concat(item.turnRight, "deg)");
        } else newPosition.transform += "rotate(".concat(item.turnRight, "deg)");
        break;
    }
  });
...
;// CONCATENATED MODULE: ./src/components/Motion/MotionBlocks/MoveSteps.js
...
const MoveSteps = _ref => {
  ...
  const [steps, setSteps] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.steps) || 10);
...
/* harmony default export */ const MotionBlocks_MoveSteps = (MoveSteps);
;// CONCATENATED MODULE: ./src/components/Motion/MotionBlocks/TurnLeft.js
...
const TurnLeft = _ref => {
  ...
  const [turnLeft, setTurnLeft] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.turnLeft) || 15);
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1  text-sm cursor-pointer rounded w-[90%]",
    ...
    draggable: true
  }, "Turn Left", /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "w-[1.5rem] mx-2 rounded text-black text-center",
    value: turnLeft,
...
/* harmony default export */ const MotionBlocks_TurnLeft = (TurnLeft);
;// CONCATENATED MODULE: ./src/components/Motion/MotionBlocks/TurnRight.js




const TurnRight = _ref => {
  let {
    data
  } = _ref;
  const [turnRight, setTurnRight] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.turnRight) || 15);
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1  text-sm cursor-pointer rounded w-[90%]",
    onDragStart: e => handleDragStart(e, {
      index: generateId(),
    ...
    draggable: true
  }, "Turn Right", /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "w-[1.5rem] mx-2 rounded text-black text-center",
    value: turnRight,
...
/* harmony default export */ const MotionBlocks_TurnRight = (TurnRight);
;// CONCATENATED MODULE: ./src/components/Motion/MotionBlocks/PointInDirection.js



const PointInDirection = _ref => {
  let {
    data
  } = _ref;
  const [pointInDirection, setPointInDirection] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.pointInDirection) || 90);
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1  text-sm cursor-pointer rounded w-[90%]",
    onDragStart: e => handleDragStart(e, {
      index: generateId(),
    ...
    draggable: true
  }, "Point in Direction ", /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "w-[1.5rem] mx-2 rounded text-black text-center",
    value: pointInDirection,
    onChange: e => !isNaN(e.target.value) && setPointInDirection(e.target.value),
    onFocus: event => event.target.select()
  }));
};
/* harmony default export */ const MotionBlocks_PointInDirection = (PointInDirection);
;// CONCATENATED MODULE: ./src/components/Motion/Motion.js
...
const Motion = () => {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "font-bold text-center w-[90%]"
  }, " Motion "), /*#__PURE__*/react.createElement(MotionBlocks_MoveSteps, null), /*#__PURE__*/react.createElement(MotionBlocks_TurnLeft, null), /*#__PURE__*/react.createElement(MotionBlocks_TurnRight, null));
};
/* harmony default export */ const Motion_Motion = (Motion);
;// CONCATENATED MODULE: ./src/components/Looks/LooksComponents/SayTextSeconds.js




const SayTextSeconds = _ref => {
  let {
    data
  } = _ref;
  const [sayTextWithSecs, setSayTextWithSecs] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.sayTextWithSecs) || "Hello!");
  const [saySeconds, setSaySeconds] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.saySeconds) || 2);
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, "Say", /*#__PURE__*/react.createElement("input", {
    type: "text",
    ...
    className: "w-[1.5rem] mx-2 rounded text-black text-center",
    value: saySeconds,
    onChange: e => !isNaN(e.target.value) && setSaySeconds(e.target.value),
    onFocus: event => event.target.select()
  }), "seconds");
};
/* harmony default export */ const LooksComponents_SayTextSeconds = (SayTextSeconds);
;// CONCATENATED MODULE: ./src/components/Looks/LooksComponents/SayText.js




function SayText(_ref) {
  let {
    data
  } = _ref;
  const [sayText, setSayText] = (0,react.useState)((data === null || data === void 0 ? void 0 : data.sayText) || "Hello!");
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-pink-500 text-white px-2 py-1  text-sm cursor-pointer rounded w-[90%] looks",
    id: "look2",
    draggable: true,
...
;// CONCATENATED MODULE: ./src/components/Looks/LooksComponents/Show.js
...
/* harmony default export */ const LooksComponents_Show = (Show);
;// CONCATENATED MODULE: ./src/components/Looks/LooksComponents/Hide.js
...
/* harmony default export */ const LooksComponents_Hide = (Hide);
;// CONCATENATED MODULE: ./src/components/Looks/Looks.js
...
const Looks = () => {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "font-bold text-center w-[90%]"
  }, " ", "Looks", " "), /*#__PURE__*/react.createElement(LooksComponents_SayTextSeconds, null), /*#__PURE__*/react.createElement(SayText, null), /*#__PURE__*/react.createElement(LooksComponents_Show, null), /*#__PURE__*/react.createElement(LooksComponents_Hide, null));
};
/* harmony default export */ const Looks_Looks = (Looks);
;// CONCATENATED MODULE: ./src/components/Main/Sidebar.js
...
function Sidebar() {
  return /*#__PURE__*/react.createElement("div", {
    className: "w-1/2 h-[100%] py-3 border-r border-gray-200"
  }, /*#__PURE__*/react.createElement("div", {
    className: "h-[100%] overflow-y-auto flex flex-col items-start px-2 gap-2"
  }, /*#__PURE__*/react.createElement(Main_Events, null), /*#__PURE__*/react.createElement(Motion_Motion, null), /*#__PURE__*/react.createElement(Looks_Looks, null)));
}
;// CONCATENATED MODULE: ./src/components/BlockFactory/BlockFactory.js
...
const BlockFactory = block => {
  switch (block.id) {
    case "SAY_TEXT_WITH_SECS":
      return /*#__PURE__*/react.createElement(LooksComponents_SayTextSeconds, {
        key: block.index,
        data: block
      });
    case "SAY_TEXT":
      return /*#__PURE__*/react.createElement(SayText, {
        key: block.index,
        data: block
      });
    case "SHOW":
      return /*#__PURE__*/react.createElement(LooksComponents_Show, {
        key: block.index
      });
    case "HIDE":
      return /*#__PURE__*/react.createElement(LooksComponents_Hide, {
        key: block.index
      });
    case "MOVE_STEPS":
      return /*#__PURE__*/react.createElement(MotionBlocks_MoveSteps, {
        key: block.index,
        data: block
      });
    case "TURN_LEFT":
      return /*#__PURE__*/react.createElement(MotionBlocks_TurnLeft, {
        key: block.index,
        data: block
      });
    case "TURN_RIGHT":
      return /*#__PURE__*/react.createElement(MotionBlocks_TurnRight, {
        key: block.index,
        data: block
      });
    case "POINT_IN_DIRECTION":
      return /*#__PURE__*/react.createElement(MotionBlocks_PointInDirection, {
        key: block.index,
        data: block
      });
    default:
...
/* harmony default export */ const BlockFactory_BlockFactory = (BlockFactory);
;// CONCATENATED MODULE: ./src/components/Main/MidArea.js
...
function MidArea() {
  ...
  const [state, setState] = (0,react.useState)(blocksState);
  ...
  }, "Mid Area"), /*#__PURE__*/react.createElement("h5", null, "Drag and drop here"), state.map(item => BlockFactory_BlockFactory(item)));
}
;// CONCATENATED MODULE: ./src/components/Main/CatSprite.js
...
;// CONCATENATED MODULE: ./src/components/Main/PreviewArea.js
...
function PreviewArea() {
  ...
  (0,react.useEffect)(() => {
    ...
    spritePosition.map(item => setStyle(prev => {
      return {
        ...prev,
        ...item
      };
  ...
  function doubleTransformValues() {
    ...
    if (translateXValue !== 0) {
      newTransformParts.push("translateX(".concat(translateXValue, "px)"));
    }
    if (rotateValue !== 0) {
      newTransformParts.push("rotate(".concat(rotateValue, "deg)"));
    }
    setStyle(prev => {
      return {
        ...prev,
        transform: newTransformParts.join(" ")
      };
    });
  }
  return /*#__PURE__*/react.createElement("div", {
    className: "h-full w-full overflow-hidden p-2 relative d-flex flex-column"
  }, /*#__PURE__*/react.createElement("div", {
    style: {
      flexGrow: 1
    }
...
;// CONCATENATED MODULE: ./src/components/Main/Header.js

const Header = () => {
  return /*#__PURE__*/react.createElement("div", {
    className: "w-full h-[6vh] px-10 flex items-center bg-purple-900"
...
function App() {
  const [blocksState, setBlocksState] = (0,react.useState)([]);
  const [spritePosition, setSpritePosition] = (0,react.useState)([{
    transition: "left 0.5s, top 0.5s, transform 0.5s"
  }]);
  ...
  }, /*#__PURE__*/react.createElement(SpritePositionContext.Provider, {
    value: {
      spritePosition,
      setSpritePosition
    }
  }, /*#__PURE__*/react.createElement("div", {
    className: "dark:bg-gray-800 dark:text-white font-sans relative h-screen flex flex-col"
  }, /*#__PURE__*/react.createElement(Main_Header, null), /*#__PURE__*/react.createElement("div", {
    className: "overflow-auto flex flex-row h-[92vh] mt-3 flex-grow"
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex-1 h-full overflow-hidden flex flex-col dark:bg-gray-700 dark:border-gray-600 rounded-xl mr-2"
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row"
  }, /*#__PURE__*/react.createElement(Sidebar, null), /*#__PURE__*/react.createElement(MidArea, null)), /*#__PURE__*/react.createElement("div", {
    className: "flex-1 w-full overflow-hidden rounded-xl mt-2"
